...
INSERT INTO `category_message` (`id`, `name`, `created_at`, `updated_at`) VALUES
(1, 'Message', '2023-10-02 06:04:58', '0000-00-00 00:00:00'),
(2, 'Promo', '2023-10-02 06:04:58', '0000-00-00 00:00:00'),
(3, 'News', '2023-10-02 06:05:05', '0000-00-00 00:00:00');
...
INSERT INTO `category_products` (`id`, `name`, `image`, `updated_at`, `created_at`) VALUES
(1, 'Ring', 'categoryproduct/RlLdEZN4lOxsFfnpdC9IsQCTBwcnrEESpZ2Cvr9c.jpg', '2023-10-19 17:50:49', '2023-10-19 17:50:49'),
(2, 'ring 2', 'categoryproduct/PI3SeQZFnUknT05izIGt0fI3mqxguLpdqyMiZlGG.jpg', '2023-10-19 17:51:04', '2023-10-19 17:51:04');

-- --------------------------------------------------------

--
-- Table structure for table `category_reward`
--

CREATE TABLE `category_reward` (
  `id` int(10) NOT NULL,
  `name` varchar(255) NOT NULL,
  `image` varchar(255) NOT NULL,
...
--
-- Dumping data for table `category_reward`
--

INSERT INTO `category_reward` (`id`, `name`, `image`, `timestamps`) VALUES
(1, 'accessories', '', '2023-10-09 18:30:09'),
(2, 'accesories', '1699038783.jpg', '2023-11-03 19:13:03');
...
--
-- Table structure for table `level_point`
--
...
CREATE TABLE `level_point` (
  ...
  `active_membership` int(10) NOT NULL,
  `image` varchar(255) NOT NULL,
...
--
-- Dumping data for table `level_point`
--

INSERT INTO `level_point` (`id`, `level`, `transaction_from`, `transaction_to`, `expiry`, `active_membership`, `image`, `description`, `created_at`, `updated_at`) VALUES
(2, 'bronze', '99', '', 2023, 0, '', 'percobaan ke', '2023-10-04 12:19:20', '2023-10-04 05:19:20'),
(3, 'platinum', '55', '', 2023, 0, '', 'desc', '2023-10-04 12:19:57', '2023-10-04 05:19:57'),
(4, 'gold', '32', '', 2023, 0, '', 'tes', '2023-10-04 01:07:04', '2023-10-04 01:07:04'),
(5, 'basic', '12', '', 2023, 0, '', 'z', '2023-10-04 12:22:02', '2023-10-04 05:22:02'),
(6, 'platinum', '76', '', 2023, 0, '', 'coba platinum', '2023-10-04 12:37:25', '2023-10-04 05:37:25'),
(9, 'bronze', '300', '', 2023, 0, '', 'test', '2023-10-05 02:06:57', '2023-10-05 02:06:57'),
(10, 'platinum', '345678', '', 2023, 0, '', 'tesssssss', '2023-10-05 02:07:16', '2023-10-05 02:07:16'),
(14, 'heheheh', '161188', '', 2024, 0, '', 'wkwkwkwkkwkwkwkwkw', '2023-10-10 13:23:57', '2023-10-10 06:23:57'),
(17, 'silver', '54321111', '', 2023, 0, '', 'testtttt', '2023-10-06 01:46:19', '2023-10-05 18:46:19'),
(18, 'gold123', '200', '', 2023, 0, '', 'test', '2023-10-17 08:54:34', '2023-10-17 08:54:34');
...
INSERT INTO `location` (`id`, `img`, `name`, `description`, `location`, `street1`, `street2`, `postal_code`, `lat`, `lng`, `phone`, `whatsapp`, `day_of_week`, `start_time`, `end_time`, `created_by`, `deleted_by`, `updated_by`, `deleted_at`, `created_at`, `updated_at`) VALUES
(1963072530, '', 'Mizora', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', '', '', '', 1497504693, NULL, 1497504693, NULL, '2023-09-28 11:55:48', '2023-10-02 00:57:54'),
(1963072531, '', 'test', '<p>hahahahahah</p>', 'Jakarta', 'BSD City', 'hahahaha', '15566', 51.49824522, -0.08590699, '2155637488', '7676786876', '5', '10:00', '20:00', NULL, NULL, NULL, NULL, '2023-11-03 12:22:55', '2023-11-03 12:22:55');
...
CREATE TABLE `member` (
  ...
  `level_point_id` int(10) NOT NULL,
...
CREATE TABLE `message` (
  `id` int(10) NOT NULL,
  `category_message_id` int(10) NOT NULL,
  `title` int(10) NOT NULL,
  `image` varchar(255) NOT NULL,
  `description` varchar(255) NOT NULL,
  `url_cta` varchar(255) NOT NULL,
  `label_cta` varchar(10) NOT NULL,
...
(1, 'hahahahahah', '1699039229.jpg', '<p>hahahahha</p>', '2023-11-03 19:20:29', '2023-11-03 19:20:29');
...
INSERT INTO `product` (`id`, `category_product_id`, `name`, `price`, `url`, `point`, `description`, `terms`, `howto`, `store`, `created_at`, `updated_at`, `img`) VALUES
(7, 0, 'test 22222', '20000', 'https://rivarenogelato.co.id/tes1', 20, '<p>test 1111222<br></p>', '', '', '', '2023-10-05 08:56:46', '2023-10-05 01:56:46', '[\"1696496206_Optimized-1_vUatPBOeK1JP9gbKmcmgqA - Copy.jpg\"]'),
(12, 0, 'produk 100', '1000000', 'https://rivarenogelato.com', 400, '<p>produk 100000<br></p>', '', '', '', '2023-10-06 01:41:16', '2023-10-05 18:41:16', '[\"1696556476_logo (2).png\"]'),
(13, 0, 'mizoraaaa', '1000000', 'https://rivarenogelato.co.id/', 3000, '<p>mizoraaaa<br></p>', '', '', '', '2023-10-05 18:43:36', '2023-10-05 18:43:36', '[\"1696556616_logo (2).png\"]'),
(15, 0, 'hahahahaha', '1000000', 'https://rivarenogelato.co.id/', 100, '<p>hahahahaha<br></p>', '', '', '', '2023-10-06 07:00:10', '2023-10-06 07:00:10', '[\"1696600810_join the presale.png\"]');
...
--
-- Table structure for table `redeem_member`
--

CREATE TABLE `redeem_member` (
  `id` int(10) NOT NULL,
...
CREATE TABLE `reward` (
  `id` int(10) NOT NULL,
  `category_reward_id` int(10) NOT NULL,
  `name` varchar(255) NOT NULL,
  `image` varchar(255) NOT NULL,
  `description` varchar(255) NOT NULL,
  `point` int(10) NOT NULL,
...
INSERT INTO `reward` (`id`, `category_reward_id`, `name`, `image`, `description`, `point`, `terms`, `howto`, `store`, `start_date_time`, `end_date_time`, `created_at`, `updated_at`) VALUES
(2, 0, 'iPhone mini', '1696600695.png', '<p>hahaha</p>', 100, '', '', '', '2023-10-06 00:00:00', '2023-11-30 00:00:00', '2023-10-06 13:58:15', '2023-10-10 13:25:35'),
(3, 0, 'Ticket Bioskop', '1696600769.png', '<p>hahahahahahahhahahahaha</p>', 10, '', '', '', '2023-10-14 00:00:00', '2023-11-30 00:00:00', '2023-10-06 13:59:29', '2023-10-06 13:59:29'),
(4, 0, 'jam tangan', '1699038825.jpg', '<p>hahahahah</p>', 200, '', '', '', '2023-11-04 00:00:00', '2023-11-30 00:00:00', '2023-11-03 19:13:45', '2023-11-03 19:13:45');
...
(6, 'Kasir', 'web', '2023-11-03 11:58:34', '2023-11-03 11:58:34');
...
(1, 'Super Admin', 'admin@test.com', NULL, '$2y$10$kkdDb1ULS0BYvDvslbngpuJkwFnDTOZZRHD1VSZwOoiFFtZzeFnCa', NULL, NULL, NULL),
...
(5, 'member@test.com', 'member@test.com', NULL, '$2y$10$mnKvQ4cQQ7cDTrbK6NIp6.egqGWqnu4/tb38bnsVlEtolACEDvHyC', NULL, '2023-10-02 22:04:16', '2023-10-02 22:04:16'),
(6, 'kasir2', 'kasir1@user.com', NULL, '$2y$10$IvxzwB9HWdTLeICbuMbUG.bL0naM0OKLVW3rirxNW2h0DPG1sxGmi', NULL, '2023-11-03 11:59:17', '2023-11-03 11:59:17');
...
--
-- Indexes for table `category_reward`
--
ALTER TABLE `category_reward`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `level_point`
--
ALTER TABLE `level_point`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `location`
  ADD PRIMARY KEY (`id`),
  ADD KEY `clubs_created_by_index` (`created_by`),
  ADD KEY `clubs_deleted_by_index` (`deleted_by`);
...
--
-- Indexes for table `redeem_member`
--
ALTER TABLE `redeem_member`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `category_reward`
--
ALTER TABLE `category_reward`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- AUTO_INCREMENT for table `level_point`
--
ALTER TABLE `level_point`
...
--
ALTER TABLE `location`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1963072532;
...
--
-- AUTO_INCREMENT for table `redeem_member`
--
ALTER TABLE `redeem_member`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;
