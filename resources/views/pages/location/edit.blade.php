                ...
                <div class="card">
                    <div class="card-header d-block">
                        <div class="d-flex flex-row">
                            <div>
                                <h3 class="pt-2">Edit Locatio {{ $location->location }}</h3>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        name="street1" value="{{ $location->street1 }}">
                                                    @error('street1')
                                                        <small class="text-danger">{{ $message }}</small>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        name="street2" value="{{ $location->street2 }}">
                                                    @error('street2')
                                                        <small class="text-danger">{{ $message }}</small>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        id="lat" name="lat" value="{{ $location->lat }}">
                                                    @error('lat')
                                                        <small class="text-danger">{{ $message }}</small>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        id="lng" name="lng" value="{{ $location->lng }}">
                                                    @error('lng')
                                                        <small class="text-danger">{{ $message }}</small>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="number"
                                                        ...
                                                        name="whatsapp" value="{{ $location->whatsapp }}">
                                                    @error('whatsapp')
                                                        <small class="text-danger">{{ $message }}</small>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        name="day_of_week" value="{{ $location->day_of_week }}">
                                                    @error('day_of_week')
                                                        <small class="text-danger">{{ $message }}</small>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        name="start_time" value="{{ $location->start_time }}">
                                                    @error('start_time')
                                                        <small class="text-danger">{{ $message }}</small>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        name="end_time" value="{{ $location->end_time }}">
                                                    @error('end_time')
                                                        <small class="text-danger">{{ $message }}</small>
                                                    @enderror
                                                </div>
